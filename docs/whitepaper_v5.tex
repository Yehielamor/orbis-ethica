...
\begin{itemize}
    ...
    \item \textbf{Genesis Wallet}: 1,000,000 ETHC (Network Bootstrap)
    \item \textbf{Founder Vesting}: 8,000,000 ETHC (Locked for 5 years)
    \item \textbf{Ethical Allocation Pool}: 1,000,000 ETHC (Grants for diverse nodes)
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Phase XIX: Advanced Visualization}: Frontend upgrade for blockchain exploration. (Next)
