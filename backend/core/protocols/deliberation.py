...
class DeliberationEngine:
    ...
    def deliberate(
        ...
        # Capture for Swarm Training
        if decision.outcome == DecisionOutcome.APPROVED:
            print("\n[Swarm Training] Capturing high-quality decision for dataset...")
            saved = self.training_manager.capture_training_example(proposal, decision)
            if saved:
                print("[Swarm Training] ✓ Saved to training_dataset.jsonl")
